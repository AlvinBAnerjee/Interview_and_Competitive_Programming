...
//    static String key2;
    ...
    static String encryption(int[] plaintext)
    {
        int[] arr = new int[8];
    ...
    static int[] function_(int[] ar, int[] key_)
    {
    ...
    public static void main(String[] args) {
        ...
        String plainText="00000001 00100011";
        key_generation();
        ...
        for (String p: plainTextArr)
        {
            String x=xor(carry,p);
            carry=encryption(str_to_arr(x));
            System.out.print(carry+" ");
        }
        System.out.println();

    }
    static int[] str_to_arr(String text)
    {
    ...
    {
        char c1=(char)(Integer.parseInt(""+a.charAt(0))^Integer.parseInt(""+b.charAt(0))+48);
        char c2=(char)(Integer.parseInt(""+a.charAt(1))^Integer.parseInt(""+b.charAt(1))+48);
        char c3=(char)(Integer.parseInt(""+a.charAt(2))^Integer.parseInt(""+b.charAt(2))+48);
        char c4=(char)(Integer.parseInt(""+a.charAt(3))^Integer.parseInt(""+b.charAt(3))+48);
        char c5=(char)(Integer.parseInt(""+a.charAt(4))^Integer.parseInt(""+b.charAt(4))+48);
        char c6=(char)(Integer.parseInt(""+a.charAt(5))^Integer.parseInt(""+b.charAt(5))+48);
        char c7=(char)(Integer.parseInt(""+a.charAt(6))^Integer.parseInt(""+b.charAt(6))+48);
        char c8=(char)(Integer.parseInt(""+a.charAt(7))^Integer.parseInt(""+b.charAt(7))+48);
